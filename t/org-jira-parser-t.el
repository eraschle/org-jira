...
(ert-deftest org-jira-parse-account-link ()
  (should
   (string= "[[https://rsrg.atlassian.net/secure/ViewProfile.jspa?name=63348c3e2eaaa5dcfa150af2][Erich Raschle]] mal schauen wie es angezeigt wird..."
            (org-jira-parse-jira-to-org "[~accountid:63348c3e2eaaa5dcfa150af2] mal schauen wie es angezeigt wird..."))))
...
(ert-deftest org-jira-org-link-without-display-name-extern ()
  (should
   (string= "[[github:nyyManni/ejira/blob/master/ejira-parse.el|smart-link][ejira-parse.el]]"
            (org-jira-parse-jira-to-org
             "[https://github.com/nyyManni/ejira/blob/master/ejira-parse.el|https://github.com/nyyManni/ejira/blob/master/ejira-parse.el|smart-link]"))))


(ert-deftest org-jira-jira-link-without-display-name-extern ()
  (should
   (string= "[ejira-parse.el|https://github.com/nyyManni/ejira/blob/master/ejira-parse.el|smart-link]"
            (org-jira-parse-org-to-jira "[[github:nyyManni/ejira/blob/master/ejira-parse.el|smart-link][ejira-parse.el]]"))))
...
(ert-deftest org-jira-org-link-with-smart-link-intern ()
  (should
   (string= "[[https://rsrg.atlassian.net/browse/ERASC-10|smart-link][ERASC-10]]"
            (org-jira-parse-jira-to-org
...
(ert-deftest org-jira-jira-link-with-smart-link-intern ()
  (should
   (string= "[ERASC-10|https://rsrg.atlassian.net/browse/ERASC-10|smart-link]"
            (org-jira-parse-org-to-jira
             "[[https://rsrg.atlassian.net/browse/ERASC-10|smart-link][ERASC-10]]"))))
